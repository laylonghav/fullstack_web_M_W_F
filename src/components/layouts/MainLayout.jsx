    ...
    <div>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className=" py-5 px-5 flex justify-between items-center border-b border-b-gray-50">
